 ...
 * @see Edge
 */
data class SimpleEdge<T>(override val start: Node<T>, override val end: Node<T>) :
    Edge<T> {
 ...
 * @see MutableEdge
 */
data class SimpleMutableEdge<T>(override var start: MutableNode<T>, override var end: MutableNode<T>) :
    MutableEdge<T> {
 ...
 */
interface WeightedEdge<T, N : Number> :
    Edge<T> {
    /**
     * Value of weight
     */
 ...
 * @see WeightedEdge
 */
interface MutableWeightedEdge<T, N : Number> : MutableEdge<T>,
    WeightedEdge<T, N> {
