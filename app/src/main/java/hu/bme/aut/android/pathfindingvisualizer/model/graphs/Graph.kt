...
data class SimpleGraph<T>(override val adjacencyList: Map<out Node<T>, Set<Edge<T>>>) :
    Graph<T> {
...
interface MutableWeightedGraph<T, N : Number> :
    WeightedGraph<T, N> {
